  ...
  const basicPriceDetails = [
    {
      ...
      price: "100,000.00",
      point1: "A dashboard with maximum of 6 graphs and a detailed report in word document",
  ...
  const standardPriceDetails = [
    {
      ...
      title2: "(DATA VISUALIZATION)",
      price: "200,000.00",
      point1: "A multi-page dashboard with a minimum of 6 graphs per page plus a detailed report overview on a dedicated presentation slide",
          ...
          <div key={index}>
            ...
            <div className="text-black py-4 px-10">
                <div>
                  <ul className="list-disc">
                    <li>{d.point1}</li>
                    <li><p className="text-blue-600">Descriptive statistics, regression analysis <span className="text-black">and </span>hypothesis testing <span className="text-black">with software tools including Excel, SPSS, R and Python</span></p></li>
                  </ul>
                </div>
              </div>
            </PricingCard>
