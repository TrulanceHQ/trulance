    ...
    <div>
      <div className="text-black text-center justify-center flex flex-col bg-blue950 w-[18rem] px-8 h-[20rem] ml-3 rounded-tl-[5rem] rounded-br-[5rem]">
        ...
        <p className="text-white font-normal text-md">
          {p1} <span className="text-buttonGreen">{p2}</span> {p3}
        </p>
      </div>
    </div>
  );
    ...
    <div className="bg-DarkBlue900 w-[18rem] h-[25rem] rounded-2xl p-4">
      <div className="overflow-hidden rounded-xl">
        <img
          src={imageLink}
          alt="A laptop"
          className="transition-transform duration-1000 ease-in-out transform hover:scale-125  hover:shadow-lg object-cover w-full h-full"
        />
      </div>
