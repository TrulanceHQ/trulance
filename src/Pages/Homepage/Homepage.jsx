...
//             Innovative solutions that supports digital transformations of
//             businesses{" "}
//           </h1>
...
//                 <span className="text-green-500 text-sm">Lance</span>, where
//                 innovation meets expertise. We are a dynamic platform offering
//                 comprehensive solutions in Web Development, Data Analysis ,
//                 Content Creation, and Digital Marketing.
//               </p>
//               <p className="">
//                 Our team of passionate professionals is committed to
//                 transforming your ideas into captivating digital experiences
...
//                 src={Img1}
//                 alt="Img1"
//                 className="w-3/4 m-auto py-4 md:w-[500px]"
//               />
//             </div>
//           </div>
//           {/* 2nd Paragarph */}
...
//             <div className="m-auto w-3/4  lg:max-w-[400px] md:m-4">
//               <p className="">
//                 With a customer-centric approach, we deliver top-notch solutions
//                 tailored to your unique needs. At{" "}
//                 <span className="text-blue-800 text-sm">Tru</span>
//                 <span className="text-green-500 text-sm">Lance</span>, we blend
//                 creativity, technical prowess, and strategic thinking to unlock
//                 the full potential of your business.
//               </p>
//               <p className="">
//                 Partner with us and embark on a journey of collaboration,
//                 excellence, and remarkable results. Let’s make your vision a
//                 reality.
//               </p>
//             </div>
//             {/* FOR THE IMAGE */}
...
//                 src={Img2}
//                 alt="Img1"
//                 className="w-3/4 m-auto py-4 md:w-[500px] md:py-1"
//               />
//             </div>
//           </div>
//           {/* THE  CTA BUTTON */}
