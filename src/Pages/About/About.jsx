  ...
  return (
    <div className="flex flex-col lg:flex-row items-center justify-between p-6 lg:p-20 bg-white shadow-md">
      ...
      <div className="w-full lg:w-1/2 lg:pr-10">
        <h3 className="font-bold text-3xl text-blue800">About Trulance</h3>
...
const AboutMeet = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 pt-12 pb-20 px-4">
      <h3 className="font-bold text-center text-3xl text-blue800 pb-8">
        Meet the Trulancers
      </h3>
