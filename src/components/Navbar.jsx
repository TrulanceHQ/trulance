...
// import ContactUsBtn from "./Buttons"; // Adjust the path as necessary
...
//             aria-controls="navbar-default"
//             aria-expanded={isOpen} // Bind aria-expanded to the state
//           >
//             <span className="sr-only">Open main menu</span>
//             <svg
//               className="w-5 h-5"
...
//         <div
//           className={`${
//             isOpen ? "block" : "hidden" // Show/hide based on state
//           } w-full md:flex flex-row justify-center md:border-none bg-transparent backdrop-blur-md md:bg-transparent border border-gray-100 rounded-lg mt-4 md:mt-0`}
//           id="navbar-default"
//         >
//           <ul className="font-medium flex flex-col pt-10 md:w-80 justify-start md:justify-center md:items-start items-center h-[80vh] md:h-auto p-4 md:p-0 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
//             <li className="w-full text-center border-b border-t border-gray-100 md:border-0">
//               <a
//                 href="/about"
//                 className={`block py-2 px-3 text-white rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-buttonGreen md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent ${isActive(
//                   "/about"
//                 )}`}
//               >
//                 About Us
...
//         <div className="hidden md:flex md:w-auto md:ml-auto">
//           {" "}
...
import React, { useState } from "react"; // Import useState to manage the toggle state
import ContactUsBtn from "./Buttons";
import { Link, useLocation } from "react-router-dom";
  ...
  return (
    <nav className="top-0 left-0 w-full backdrop-blur-md z-10 fixed border-gray-200 dark:bg-gray-900">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        {/* Contact Us button on the top right */}
        <div className="hidden w-full md:w-auto md:flex flex-row justify-between">
          <a href="/#ContactUs">
            <ContactUsBtn label={"Contact Us"} />
          </a>
